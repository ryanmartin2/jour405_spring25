---
title: "Chi-Square Test for College Letter Grades" - Ryan Martin
---
...
Off the bat, I think the observed frequency is not that different from the intended frequency. Together, the observed frequency only differed slightly  away from the expected frequency, although Grades A and C (20 oberservations off each) did show the highest difference.
...
After looking at the chi-square statistic of 11.667, we can see that it is greater than the critical value of 9.487729 which means we can reject the null hypothesis at the .05 alpha level.
...
Each grade category experienced differences from expected and observed frequencies. Grade B experienced the least discrepancy since it was 96% of what the expected frequency would be while Grade F was the most notable discrepancy since it was only 75% accurate. The questions I would ask either the instructor or the college about the discrepancies is what are either of them doing to insure ac curacies in the observed frequency matching the expected frequency? And, is it more likely that a observed frequency differs farther from an expected frequency if you go down to the worse grades of D and F?
