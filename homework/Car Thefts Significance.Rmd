...
My initial reaction is that car thefts have decreased a ton and it has trended downwards.
...
The 95% confidence interval here shows that we are 95% confident that in the distribution to the mean.
The figures that acurately reflect the number of car thefts in a typical month are the mean thats associated with the dotted red line through the data.

Headline: Monthly Car Theft Trends Show a Safer Future Ahead.
...
Because of the high p-value, the difference between the two periods is not statistically significant and we cannot reject teh null hypothesis.

Adjusting my headline from Task 6, I would change it to "Car Theft Shows Little Change Since Alarming Rates", which would probably frustrate the editor becuase it has less of a punch than the previous headline. She would probably question what changed for the difference in headline.
