...
The time series visualization shows us how in early 2020, the number of daily accidents in Prince George's County went down significantly compared to the other years in the visualization. Another pattern noticed is the huge range in which the daily number of accidents looks like they fluctuated in late 2022. This leads to the question of "Why?" at both times — why did the statistic fall in early 2020 (COVID?) and what made the values in late 2022 so extreme? In this way, we can see how the visual patterns could quickly translatye to potential story angles.
...
The lowest average accidents occur in the middle of the week on Tuesdays and Wednesdays while the highest average accident numbers happen during the weekend on Friday, Saturday, and Sunday. These patterns make sense if, on average, we can assume more people are driving for leisure during the weekend and not stuck at their offices or jobs.
...
The day that stuck out to me the most was Friday, October 29th, 2021. We can see here how the 58 accidents in Prince George's County was well higher than the average based on the 4.77 Z-Score. After doing some research, the most notable events that could lead to more accidents on that day than average would be the major tidal flooding that occurred in Maryland. The flooding was the worst Bay Tidal Flooding that Maryland had seen in 50 years making it the very likely culprit for an increase in accidents and important thing to note within the context of the story.
...
The overall extreme z-scores differ from the day-of-week z-scores because the day-of-week z-scores are closed to the median number of 2 than the overall extreme z-scores are. This is because when the extreme z-scores are compared to the overall data, they're seen as a bigger outlier than when compared to the specific day-of-week Z score. As a journalist, we can compare these two different approaches to measuring what is considered an "unusual day" by understanding that, in the context of the data, a higher z-score should be compared to its day-of-week average and not the overall average. This becomes especially important when we take the early visualization into account and remember the differences between middle of week and weekend car accident trends.
...
The monthly pattern analysis shows that the highest average accidents happen in the last three months of October, November, and December while the lowest average accident months are the first quarter of the year with January, February, and March. There's a consistent trend, though, as a trend line through the whole year would show a consistent progression of more and more average accidents as the year goes on. My hypithesis is that these seasonal patterns exist because people tend to be more careful with their driving, especially when getting new cars during the holiday season, yet that carefulness decreases as the year goes on.
...
With the exception of Monday, November 11th, 2021, the extreme outliers identified all occured on the weekend days of either Friday, Saturday, or Sunday.
...
Story pitch: I would write about the alarming trend in Prince George's County average accidents and how they've been consistently shown statistically to happen more frequently during the weekend than on the weekdays. I'd be interested in investigating why that is the case and speaking with PG County Department of Public Works and Transportation as well as PG County Police to see why these trends are happening and what citizens can be better doing during the weekend days to keep themselves and their vehicles safe from these accidents. I would also speak with a victim of a recent PG County accident to get a first-person perspective of an accident happening locally.

Headline: New Alarming Data Shows PG County Accidents Ramp Up During Weekends

Lede: Prince George's County citizens need to start paying extra attention on the road while driving during the weekend — or it'll cost them. New data published in JOUR405 shows that the average number of local accidents consistently spikes during the weekend, an alarming trend that PG County Department of Public Works and Transportation director Derek Willis calls a "local epidemic".
