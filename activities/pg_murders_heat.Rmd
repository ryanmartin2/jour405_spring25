...
The correlation calculation shows that there is correlation between the temperature and number of murders increasing in unison. Since the correlation is over 58%, we can see that the number of murders is moderately correlated with the temperature. The scatterplot confirms this because the two months shows in the plot near the highest murder rates, June and July, come during the peak summer months.
