...
The correlation calculation and scatter plot both show how there's little to no correlation between the goal differential and the fouls. The correlation calculation does this by showing how the two are over 99% unrelated while the scattterplot shows visually the lack of a trend between the data points.
