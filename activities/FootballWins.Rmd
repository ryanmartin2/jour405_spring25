...
Based on what we've seen, there's not much more than the obvious that this model provides. The only significant event that the model showed was that the more points a team scored, the more likely it essentially was to win. This is seen as obvious, and not as telling as the model was likely made to be. It was be more noteworthy if there was clear significance in a stat aside from scoring points that showed a high coefficient in leading to wins, such as takeaways.
...
Points scored is by far the most impactful statistic on wins, a stat that seems pretty obvious to the average sports fan. Some don't seem very impactful, most notably Yards Gained seems to have the least amount of correlation to overall wins and can be taken out because of their limited impact on wins, as seen in the top right most and bottom left most corners.
...
I would use this model to cover a game because it gives you a better understanding of what statistics to be looking out for and what statistics can really impact a game. This becomes especially important when trying to differentiate between the common and uncommonalities that can lead to winning.
