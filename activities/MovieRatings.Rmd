...
The latter set is different than expected because based on each star count, there were more or less responses than expected. For instance, there were fewer five stars handed out than expected.
...
We would reject the null hypothesis because the chi-square statistic observed is higher, meaning the actual values are significantly different than the expected values.
