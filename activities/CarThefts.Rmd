...
In general, we can see that the data is left-skewed, showing that the average alone doesn't tell the full story of the average of car thefts. This shows the application of standard deviation and drawn-out histograms in the context of reporting — the average doesn't accurately, fully describe what's going on.
