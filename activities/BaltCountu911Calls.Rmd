...
Now let's count how many 911 overdose calls occurred on each day: Maxed out at 23
...
If we were to draw horizonta lines, I think your range would visually be from 17.5 calls to 7.5 calls
...
The unusual days as determined here differ from my answer in Task 3 because my Task 3 answers offered a much wider range from about 8-18 where as the range here was much more narrow from 11-7. The Z-scores here show sensitivity to the small numbers.
...
Saturday has the highest average of 911 calls in Baltimore County across the data span studied.
...
Some potential angles for reporting depend on what direction you want to go in. One angle you could take would be how the average 911 overdose calls increase heavily during the spring and summer months — a reporter could take the investigative angle into seeing what factors annually contribute to that increase. A journalist could also look into when the overall overdosing calls is peaking and then go to identify what drugs are in the community and how they be more lethal than typical drugs. Essentially, all of this data shows overdoses are happening without explaining the "Why" behind all of these statistics, which then becomes the journalist's objective to figure out. My next steps to an editor would be to bring one or two of the angles previously mentioned to them and propose that I go speak with local authoritites and hear what their concerns are in their community and what they believe is causing the fluctuation/peaks of overdose calls.
